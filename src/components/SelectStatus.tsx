  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <select
        ...
        } w-full rounded-xl border border-gray-300 dark:border-gray-700 px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:text-gray-100`}
        value={value ?? ""}
